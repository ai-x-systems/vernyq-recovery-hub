        ...
        <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="max-w-2xl">
            ...
            <p className="text-body-lg text-[#faf9f7]/70 mt-6 max-w-lg leading-relaxed">
              All-in-one cold plunge systems engineered for serious recovery.
              Integrated cooling, filtration, and insulation — designed to
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              ...
              <Link
                to="/science"
                className="inline-flex items-center justify-center gap-2 h-12 px-8 border border-[#faf9f7]/20 text-[#faf9f7] text-body-sm font-medium rounded-[0.5rem] hover:bg-[#faf9f7]/10 transition-colors"
              >
                Explore the Science
              </Link>
            </div>
            ...
            {[
              {
                ...
                description:
                  "Integrated chiller, filtration, and insulation. No third-party add-ons required.",
              },
              {
                icon: Shield,
                title: "Premium Materials",
                description:
                  "Marine-grade stainless steel exterior with medical-grade interior liner.",
              },
              {
                icon: Award,
                title: "Consistent Performance",
                description:
                  "Maintain your exact target temperature, every session, without ice.",
              },
              {
                icon: Home,
                title: "Home-Ready",
                description:
                  "Standard 110V outlet. No special electrical work. Set up in under an hour.",
              },
              {
                icon: Repeat,
                title: "Low Maintenance",
                description:
                  "Built-in filtration and UV sterilization. Change water every 2–4 weeks.",
              },
              {
                icon: Timer,
                title: "Always Ready",
                description:
                  "Set your temperature. Walk outside. Plunge. No preparation needed.",
              },
            ].map((item) => (
              <div
                key={item.title}
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-body-lg text-[#555555] mt-4 leading-relaxed">
                Most cold plunge setups require you to buy a tub, a separate
                chiller, filters, and figure out how to connect everything. A
                VERNYQ system arrives as one integrated unit.
              </p>
      ...
      <section className="py-20 lg:py-28 bg-[#f3f1ee]">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            description="Every component is selected for performance, durability, and long-term reliability."
          />
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="text-body-lg text-[#555555] mt-4 leading-relaxed">
                A cold plunge at home means your recovery tool is always ready.
                No driving to a facility. No waiting for availability. Just step
                outside and start.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Choose your target — typically 3°C–10°C.",
                  },
                  {
                    step: "02",
                    title: "Step In",
                  ...
                  },
                  {
                    step: "03",
                    title: "Recover",
                    desc: "2–5 minutes of cold exposure. Step out, warm up, feel the difference.",
                  },
                ].map((item) => (
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <p className="text-body-lg text-[#faf9f7]/70 mt-4 leading-relaxed">
                Cold water immersion has been studied extensively in exercise
                science and recovery research. While findings vary, consistent
                themes emerge around temperature, duration, and frequency.
              </p>
              <p className="text-body text-[#faf9f7]/50 mt-4 leading-relaxed">
                We believe in evidence-based recovery. That means understanding
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={item.label}
                  className="bg-[#faf9f7]/5 border border-[#faf9f7]/10 rounded-[0.5rem] p-6 text-center"
                >
                  <p className="text-h2 text-[#faf9f7]">{item.stat}</p>
                  <p className="text-caption text-[#faf9f7]/50 mt-1">
                    {item.label}
                  </p>
                </div>
              ))}
      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            description="Two tiers of premium recovery. Both designed as complete all-in-one solutions."
          />
      ...
      <section className="py-20 lg:py-28 bg-[#f3f1ee]">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            description="Everything you need to know before purchasing."
          />
      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            overline="Journal"
            title="From the Blog"
            description="Research, setup guides, and recovery education."
          />
